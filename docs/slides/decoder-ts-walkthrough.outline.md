...
Topic: Explain how `src/core/decoder.ts` works (step-by-step / component-by-component: roles, function, I/O, invariants).
...
- `codeBlock`: `src/core/decoder.ts` lines 3–12 (header comment), highlight 8–11.
...
- `codeBlock`: `src/core/decoder.ts` lines 1–1 (OnData), and 181–199 (ChunkedCollectingDecoder) with highlight 181–187 and 193–198.
...
- `codeBlock`: `src/core/decoder.ts` lines 13–26 (state + state variables), highlight 14, 17–18, 21, 24–25.
...
Concept: `core`
Blocks:
- `codeBlock`: `src/core/decoder.ts` lines 29–34 (early return + cursor + loop), highlight 30–33.
...
Concept: `states`
Blocks:
- `codeBlock`: `src/core/decoder.ts` lines 34–65, highlight 37–55 and 57–64.
- `explanation`: Notes:
...
Concept: `states`
Blocks:
- `codeBlock`: `src/core/decoder.ts` lines 67–83, highlight 68–76 and 78–81.
- `explanation`: Notes:
...
Concept: `states`
Blocks:
- `codeBlock`: `src/core/decoder.ts` lines 85–98, highlight 86–96.
- `codeBlock`: `src/core/decoder.ts` lines 114–118, highlight 114–118.
- `explanation`: Notes:
...
Concept: `states`
Blocks:
- `codeBlock`: `src/core/decoder.ts` lines 48–52 (the `n===0` branch), highlight 48–51.
- `codeBlock`: `src/core/decoder.ts` lines 105–112 (isDone/finalize), highlight 105–112.
...
Concept: `collect`
Blocks:
- `codeBlock`: `src/core/decoder.ts` lines 121–173, highlight 132–151 and 160–173.
- `explanation`: Notes:
...
Concept: `collect`
Blocks:
- `codeBlock`: `src/core/decoder.ts` lines 181–199, highlight 182–187 and 193–198.
